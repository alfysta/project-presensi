...
<head>
    ...
    <meta property="og:description"
        content="Tabler comes with tons of well-designed components and features. Start your adventure with Tabler and make your dashboard great again. For free!">
    <!-- CSS files -->
    <link href="{{ asset('vendor/assets/dist/css/tabler.min.css?1674944800') }}" rel="stylesheet" />
    <link href="{{ asset('vendor/assets/dist/css/tabler-flags.min.css?1674944800') }}" rel="stylesheet" />
