...
<div class="appBottomMenu">
    <a href="{{ route('home') }}" class="item{{ request()->is('/') ? ' active' : '' }}">
        <div class="col">
    ...
    <a href="{{ route('history.index') }}" class="item{{ request()->is('presensi/history') ? ' active' : '' }}">
        <div class="col">
    ...
    <a href="{{ route('izin.index') }}" class="item{{ request()->is('presensi/izin') ? ' active' : '' }}">
        <div class="col">
